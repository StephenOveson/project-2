...
// initializes Map
// function initMap() {
//   let SaltLakeCity = {lat:40.758701, lng:-111.876183};
...
//   searcButton = document.getElementById("searchButton").onclick = searchLocations;

//   locationSelect = document.getElementById("locationSelect");
//   locationSelect.onchange = function() {
//     let markerNum = locationSelect.options[locationSelect.selectedIndex].value;
//     if (markerNum != "none"){
//       google.maps.event.trigger(marker[markerNum], "click");
//     }
//   };
// }
...
// was learning how to convert files into XML format
// idea was to take data into sequelize then take the xml formatted data and 
// either append to an actual map with window markers and information,
// or create an element that appends the information 
